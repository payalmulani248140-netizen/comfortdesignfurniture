...
class PriceRange extends HTMLElement {
    ...
    super();
      ...
      // Sliders
      this.minSlider = this.querySelector('.thumb-min');
      this.maxSlider = this.querySelector('.thumb-max');

      // Fill bar
      this.fill = this.querySelector('.range-fill');

      // Bubbles
      this.minBubble = this.querySelector('.bubble-min');
      this.maxBubble = this.querySelector('.bubble-max');

      // Input boxes
      this.minInput = this.querySelector('.input-min');
      this.maxInput = this.querySelector('.input-max');

      const maxLimit = parseInt(this.maxSlider.max);
      ...
      // Slider updates
      this.minSlider.addEventListener('input', () => this.updateFromSlider());
      this.maxSlider.addEventListener('input', () => this.updateFromSlider());
    ...
    updateFromSlider() {
      ...
      // Bubble text (Shopify money)
      // this.minBubble.innerHTML = Shopify.formatMoney(minVal * 100);
      // this.maxBubble.innerHTML = Shopify.formatMoney(maxVal * 100);

      // Bubble positioning
      const sliderWidth = this.minSlider.offsetWidth;
      this.minBubble.style.left = (percentMin * sliderWidth / 100) + "px";
      this.maxBubble.style.left = (percentMax * sliderWidth / 100) + "px";
    }
}
